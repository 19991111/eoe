...
def run_v16_9_experiment(
    ...
    print("=" * 70)
    print("🔬 v16.10 欺骗性景观实验 - 温和税收版")
    print("=" * 70)
    print("  目标: 打破伏地魔策略，同时维持复杂度")
    print("  策略: 温和税收 + 可预测轨迹 + 课程学习")
    print("  调整: tax_rate 0.08→0.03, tax_steps 50→80")
    print("=" * 70)
    ...
    stationary_tax = StationaryTaxModifier(
        threshold_dist=0.05,  # 移动距离阈值
        tax_steps=20,         # 连续20步不动开始征税
        tax_rate=0.01,        # 很低税收
    )
