...
def run_experiment(
    ...
    # 配置能量场参数 - 大幅增加能量补充
    env.energy_field.n_sources = 15          # 更多能量源
    env.energy_field.source_strength = 300.0 # 强脉冲
    env.energy_field.source_capacity = 1500.0 # 大容量
    env.energy_field.decay_rate = 0.90        # 慢衰减
    env.energy_field.respawn_threshold = 0.40 # 40%时重生
...
if __name__ == '__main__':
    ...
    parser.add_argument('--steps', type=int, default=2000, help='运行步数')
