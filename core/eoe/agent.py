...
class Agent:
    ...
    def __init__(
        ...
        # v5.7 战斗统计 (兼容环境代码)
        self.energy_stolen: float = 0.0   # 战斗中窃取的能量
        self.battle_wins: int = 0         # 战斗胜利次数
        self.battle_losses: int = 0       # 战斗失败次数
        ...
        # ============================================================
        # v0.0: 统一场物理系统 - 控制器输出 (Controller Outputs)
        # 四个纯物理参数，由大脑神经网络直接控制
        # ============================================================
    ...
    def get_controller_outputs(self) -> dict:
        """
        v0.0 获取控制器输出 (供 ThermodynamicLaw 使用)
        """
        return {
